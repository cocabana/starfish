...
function toDeployments(json: any): Deployments {
  const contracts = {
    DIDRecord: {
      ...
      contractInstance: DIDRecord.at(
        json.contracts["DIDRecord"].contractInstance.address
      ),
    },
    DIDRegistrar: {
      ...json.contracts["DIDRegistrar"],
      contractInstance: DIDRegistrar.at(
        json.contracts["DIDRegistrar"].contractInstance.address
      ),
    },
  };
  return {
